...
func TestGoToolchainsStayOnApprovedVersions(t *testing.T) {
	...
	// This fork pins Go 1.20, the last release supporting macOS 10.13. The CI
	// workflows above stay on upstream's pinned toolchain; only the module's
	// own language version diverges.
	mustMatch(t, goMod, `(?m)^go 1\.20$`)
