...
<ul>
	...
	<li>✓ <strong>Android: screenshot protection</strong>: an optional <strong>Privacy &amp; Security</strong> toggle (on by default) applies <code>FLAG_SECURE</code> to block screenshots and screen recording and hide the app in the recent-apps switcher</li>
